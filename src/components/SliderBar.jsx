            ...
            >
                ...
                <figcaption className="text-xl sm:text-3xl md:text-4xl lg:text-5xl absolute inset-0 flex flex-col gap-2 sm:gap-4 items-center justify-center bg-black/30 text-gray-100 p-2 w-full h-[500px] md:h-[700px]">
                    ...
                    <div className="flex gap-4 mt-4 text-base sm:text-lg lg:text-xl">
                        <a 
                        target='_blank' 
                        href="https://wa.me/+5491140963523?text=%C2%A1Hola!%20%F0%9F%91%8B%20Estoy%20interesado/a%20en%20la%20venta%20y%20colocaci%C3%B3n%20de%20membranas%20para%20techos.%20%F0%9F%8F%A0%20%C2%BFPodr%C3%ADan%20brindarme%20informaci%C3%B3n%20sobre%20precios%20y%20disponibilidad%3F%20Gracias." 
